...
class patcher(patcher):
    ...
    def gen_bra(self, image):
        ...
        sx = 0
        sy = 0
        design_seamless = np.pad(
            design_seamless, [(posy + sy + 1, posy - sy), (posx + sx, posx - sx)], mode="constant"
        )
        ...
        if self.use_ribbon_mesh is False:
            ...
            [r, c, d] = ribbon.shape
            textured[460 : 460 + r, 35 : 35 + c] = (
                textured[460 : 460 + r, 35 : 35 + c] * (1 - ribbon[:, :, 3][:, :, None])
