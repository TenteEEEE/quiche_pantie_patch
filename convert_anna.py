...
if fname in panties:
    ...
    # plt.plot((np.sin(np.linspace(0, 1 * np.pi, src.shape[0]))[-30:]*150))
    ...
    # Finalize
    pantie = skt.resize(pantie,(np.int(pantie.shape[0]*1.25),np.int(pantie.shape[1]*1.60)),anti_aliasing=True,mode='reflect')
